...
<head>
    ...
    <title><?php echo $invitation ? strip_tags($invitation->heading) : 'Undangan Digital' ?></title>
    ...
    <meta itemprop="image" content="<?php echo $invitation ? $invitation->cover_url : 'https://websiteanda.com/inv/logo.jpg' ?>">
